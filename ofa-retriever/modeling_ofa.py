...
from transformers.models.ofa.configuration_ofa import OFAConfig
from transformers.models.ofa.resnet import ResNet
...
class OFAEncoder(OFAPreTrainedModel):
    ...
    def forward(
        ...
        if patch_images is not None:
            ...
            # TODO(haofeiyu): do not understand why need to comment here
